...
export default function CurrentlyBuilding() {
  // Dynamically find EVE or any In Development project
  const activeProj = PROJECTS.find(p => p.id === "eve") || PROJECTS.find(p => p.status === "In Development");
  ...
  return (
    <section className="py-12 border-t border-white/5 text-left">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Premium bento-style card showcasing the flagship build */}
          ...
          <div className="relative flex flex-col md:flex-row md:items-start justify-between gap-6">
            ...
            <div className="space-y-4 max-w-xl">
              <div className="flex items-center space-x-2">
                <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold tracking-tight bg-cyan-400/10 text-cyan-450 border border-cyan-500/20">
                  {activeProj.status || "Active Development"}
                </span>
                <span className="text-xs text-gray-500 font-mono">
                  {activeProj.period || "Jun 2026 - Present"}
                </span>
              </div>
              ...
              <p className="text-sm text-gray-350 leading-relaxed font-sans">
                An AI COO platform designed to help small businesses streamline workflows, automate repetitive tasks, and improve operational decision-making using AI-powered systems.
              </p>
